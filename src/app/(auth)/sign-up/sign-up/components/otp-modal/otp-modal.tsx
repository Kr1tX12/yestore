  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogContent className="bg-zinc-950 flex flex-col justify-center items-center gap-8">
        ...
        <Button onClick={() => setOpen(false)} size="icon" variant="ghost" className="absolute top-1 right-1 text-zinc-500">
          <X className="size-12" />
        </Button>
        ...
        <div>
            Не получили код?{" "}
            <Button onClick={handleResetOTP} type="button" variant="link" className="pl-1 text-blue-400">
              Отправьте ещё раз!
            </Button>
          </div>
      </AlertDialogContent>
